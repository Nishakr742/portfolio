...
const Data = () => {
    return (
        <div className='home_data'>
            <h1 className='home_title'>Ravi Ranjan
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className='home_description'>I'm very passionate to front end development and I'm dedicated to my work</p>
          <a target='_blank' href='https://api.whatsapp.com/send?phone=+918651384873&text=Hi%20Sir%20!' className='button button-flex'>Hello <span><i className="uil uil-whatsapp"></i></span></a>
        </div>
    );
}
